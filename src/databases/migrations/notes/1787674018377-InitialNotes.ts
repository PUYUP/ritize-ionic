...
export class InitialNotes1787674018377 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "pages" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "pageNum" integer NOT NULL, "isActive" boolean NOT NULL, "noteId" integer)`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "notes" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "workspaceId" varchar NOT NULL)`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "temporary_pages" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "pageNum" integer NOT NULL, "isActive" boolean NOT NULL, "noteId" integer, CONSTRAINT "FK_8eb51553e685d2ca0053518e460" FOREIGN KEY ("noteId") REFERENCES "notes" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
