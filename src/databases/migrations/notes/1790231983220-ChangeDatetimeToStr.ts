...
export class ChangeDatetimeToStr1790231983220 implements MigrationInterface {
    name = 'ChangeDatetimeToStr1790231983220'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "temporary_pages" ("id" varchar PRIMARY KEY NOT NULL, "pageNum" integer NOT NULL, "isActive" boolean NOT NULL, "contentData" blob, "noteId" varchar, "syncedAt" varchar, "userId" varchar NOT NULL, "workspaceId" varchar NOT NULL, "workspaceNoteId" varchar NOT NULL, "syncedId" varchar, "title" varchar, "attributes" text, "contentText" varchar, "contentExtracted" text, "status" varchar DEFAULT ('draft'), "processingStatus" varchar DEFAULT ('pending'), "learningSessionId" varchar, "createdAt" varchar, CONSTRAINT "FK_8eb51553e685d2ca0053518e460" FOREIGN KEY ("noteId") REFERENCES "notes" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_pages"("id", "pageNum", "isActive", "contentData", "noteId", "syncedAt", "userId", "workspaceId", "workspaceNoteId", "syncedId", "title", "attributes", "contentText", "contentExtracted", "status", "processingStatus", "learningSessionId", "createdAt") SELECT "id", "pageNum", "isActive", "contentData", "noteId", "syncedAt", "userId", "workspaceId", "workspaceNoteId", "syncedId", "title", "attributes", "contentText", "contentExtracted", "status", "processingStatus", "learningSessionId", "createdAt" FROM "pages"`);
        await queryRunner.query(`DROP TABLE "pages"`);
        await queryRunner.query(`ALTER TABLE "temporary_pages" RENAME TO "pages"`);
        await queryRunner.query(`CREATE TABLE "temporary_notes" ("id" varchar PRIMARY KEY NOT NULL, "workspaceId" varchar NOT NULL, "syncedAt" varchar, "userId" varchar NOT NULL, "title" varchar, "content" varchar, "noteDatetime" varchar, "contentType" varchar NOT NULL, "syncedId" varchar, "attributes" text, "status" varchar DEFAULT ('draft'), "processingStatus" varchar DEFAULT ('pending'), "learningSessionId" varchar, "createdAt" varchar)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "notes" ("id" varchar PRIMARY KEY NOT NULL, "workspaceId" varchar NOT NULL, "syncedAt" datetime, "userId" varchar NOT NULL, "title" varchar, "content" varchar, "noteDatetime" datetime, "contentType" varchar NOT NULL, "syncedId" varchar, "attributes" text, "status" varchar DEFAULT ('draft'), "processingStatus" varchar DEFAULT ('pending'), "learningSessionId" varchar, "createdAt" datetime)`);
        ...
        await queryRunner.query(`INSERT INTO "pages"("id", "pageNum", "isActive", "contentData", "noteId", "syncedAt", "userId", "workspaceId", "workspaceNoteId", "syncedId", "title", "attributes", "contentText", "contentExtracted", "status", "processingStatus", "learningSessionId", "createdAt") SELECT "id", "pageNum", "isActive", "contentData", "noteId", "syncedAt", "userId", "workspaceId", "workspaceNoteId", "syncedId", "title", "attributes", "contentText", "contentExtracted", "status", "processingStatus", "learningSessionId", "createdAt" FROM "temporary_pages"`);
