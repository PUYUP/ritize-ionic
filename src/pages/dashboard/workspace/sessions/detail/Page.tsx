...
import { bookmarkSharp, checkmarkDoneSharp, closeOutline, pencilOutline, pricetagsSharp, settingsOutline, timeOutline, trashOutline } from 'ionicons/icons';
            ...
            <IonContent color={'light'}>
                ...
                {sessionData?.status !== 'completed' && (
                    <div className='-mt-6 relative z-20 flex gap-3 justify-center'>
                        <IonButton mode="md" shape="round" color="success" style={{ 'minHeight': '44px' }}>
